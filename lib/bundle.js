    ...
    /***/ function (module, exports) {
      ...
      class Cloud {
        ...
        draw() {
          ...
          // cloudImage.src = "./assets/images/cloud.jpg";
      ...
      class Naruto {
        constructor() {
          ...
          this.image.src = "./assets/images/Kakaoguy2.png";
        }
      ...
      naruto.setPosition(
        (width - naruto.width) / 2,
        (height - naruto.height) / 2
      );
      naruto.jump();
      ...
      function checkKeyPressed(e) {
        if (e.keyCode === 37) {
          ...
          points = 0;
          naruto.setPosition(
            Math.floor((width - naruto.width) / 2),
            (height - naruto.height) / 2
          );
          naruto.jump();
          gameLoop();
      ...
      function gameLoop() {
        ...
        if (keyLeft) {
          naruto.left();
          naruto.image.src = "./assets/images/Kakaoguy2.png";
        } else if (keyRight) {
          naruto.right();
          naruto.image.src = "./assets/images/Kakaoguy2.png";
        }
